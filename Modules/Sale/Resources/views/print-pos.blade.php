...
<div style="max-width:400px;margin:0 auto">
    <div id="receipt-data">
        ...
        <p>
            Tanggal: {{ \Carbon\Carbon::parse($sale->created_at)->format('d M Y h:i:s') }}<br>
            Nomor Ref: {{ $sale->reference }}<br>
        ...
        <table>
            <tbody>
                <tr style="background-color:#ddd;">
                    ...
                    <td class="centered" style="padding: 5px;">
                        Jumlah: {{ format_currency($sale->paid_amount) }}
                    </td>
                </tr>
                <tr style="border-bottom: 0;">
                    <td class="centered" colspan="3">
                        ...
                        <div style="margin-top: 5px;">
                            Terima Kasih Sudah Berbelaja ^_^
                            </div>
                    </td>
                </tr>
            </tbody>
